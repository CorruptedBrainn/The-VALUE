...
public:
  ...
  enum {
    ...
    RuleBinaryoperator = 16, RuleBooleanoperator = 17, RuleComparisonoperator = 18, 
    RuleAdditiveoperator = 19, RuleMultiplicativeoperator = 20, RuleNotoperator = 21, 
    RuleIncrementaloperator = 22, RulePrimaryexpression = 23
  };
